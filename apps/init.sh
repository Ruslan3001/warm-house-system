...
# Используем docker-compose из корня проекта
...
echo ""
echo "To view logs, run: docker compose -f ../docker-compose.yaml logs -f"
echo "To stop the services, run: docker compose -f ../docker-compose.yaml down"